...
## 역할
신규 작품의 **아이디어 4-8개를 생성·제출**한다. 이 단계는 청사진 초안(step_1_1)을 작성하기 위한 **선행 단계**다. 사용자가 아이디어를 1개 선택하거나, AI가 자율 선택 후 보고. 선택된 아이디어가 step_1_1의 input이 된다.
...
9. **종료 안내 (3줄):**
   ...
   - `다음: 청사진 초안(step_1_1)으로 진행할까요?`

## 출력 양식 예시 (참고)

```markdown
# [작품 슬러그] — 아이디어 풀 (step_0_1)
