...
| `26_empire_dowry` | 《그 제국은 내 지참금이다》 / THE EMPIRE WAS HER DOWRY | **러프 기획안 v1 (2026-08-07)** — 글로벌 여성향·복수/권선징악 메인·**1890s 금박시대 뉴욕**·EN 발화·50화 내외·무료 8(제안). **원안 = `C:\Users\Rowan\Downloads\내가 세우고 내가 무너뜨린다.역대본.md`**(NetShort 50화) — 무료런 굴욕 적립 구조·클리프 형태·킬러 대사 1:1 이식, 시대만 치환(사용자: 감정·구조 보존, 시대상·세계관 교체, 여성향). 인물 = 이블린 윈스럽(상속녀·임신)/줄리언 콜(남편·후회남)/델라(정부)/마사 콜(시어머니·며느리 편). 공간 = 부두(1화)→콜 팰리스 호텔 개관식(8화까지). 소품 2(유품 진주 목걸이·1주년 브로치)·전기뱀장어 수조 유지(팜코트 수족관). 무료 8화 컷 = 남편이 젖은 여자 턱을 들어 올려 얼굴 확인 프리즈(원작 9화 비트 반 발 당김). 정본 = `26_empire_dowry_p0_rough.md`·이력 = `26_empire_dowry_00_meta.md`. 잔여 = 사용자 채택 판정 → phase_p·타이틀 확정 |
