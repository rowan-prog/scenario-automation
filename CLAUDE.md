...
| `16_moses` | 내 남편은 거지 모세 / I Chose a Slave, But He Parts the Sea | **작가 최종 대본 1~50화 검수 완료 (2026-08-11).** 원본 = `C:\Users\Rowan\Downloads\I Chose a Slave, But He Parts the Sea_내 남편은 거지 모세_대본.docx`(변경이력 0) · 추출 = `03_작업파일/_final_ep1-50.txt` · **산출 = `내 남편은 거지 모세_최종대본_검수의견_31-50화 중심.docx`**(빌더 `04_스크립트/_build_review_final.py` · 총평 + 구조 5 + 31~50화 회차별 46 + 1~30화 잔여 24 + 표기 일괄 · 원문 인용 84건 기계 대조 불일치 0). **구조 5 = ①49화 엔진 미정산(팔찌 킬러 대사 누락) ②41화 이후 인질 카드 전부 무효(라반·네페라 39화 이후 10화 부재) ③38→39화 장자 재앙 직후 다말이 환하게 웃음 ④클리프 5개(35·37·39·42·45화) 유인 0 ⑤45·46화 = 진도 반 화·45화 모세 전무.** 하드 = 49화 "이집트"·45~46화 모래/불기둥 혼용·40화 모세 손 치유(G1 위반)·38화 빈 저택 표식·왕자 셋업 0. **히트작 대조로 철회 = 후반 대사량 급감**(원작 아폴론 후반 6.4줄 < 우리 9.5줄) · 씬1개 화 · 조연 결장. 1~30화는 v17 코멘트 중 기계·표기성만 반영됨. 잔여 = 사용자 선별 → 작가 발송. 이하 = 이전 라운드 (2026-08-03 1~21화 2차 회수본) — 여성향 회귀 리벤지 판타지·50화·무료 1~7·각색 원작 《Swapped to a Beggar But He is Apollo》(48화·플롯 구조 그대로 = 사용자 확정). **작가에게 나가는 것 3종 = `내 남편은 거지 모세_각색 가이드_v18.docx` · `_회차 트리트먼트_1-50화_v7.docx` · `_1-21화_검수코멘트_v11.docx`**(코멘트 27개 = 오류 레벨만·사용자 지시로 부담 관리). 진단 = 작가는 **코멘트 단 자리만 고치고 가이드 표는 전수 미적용**(연꽃 52→1 vs 사제 17→15) → 앞으로 앵커 필수. 기획안 = `Vigloo AI Drama Proposal_I Chose a Slave, But He Parts the Sea.docx`(05_구버전) · 원안 = `_p0_source.md` · 이력 = `16_moses_00_meta.md` · 폴더 지도 = `README.md`. ⚠️ 회수본 docx는 변경 이력 수락 후 읽을 것([[docx-conversion-drops-table-textbox-text]] 2차 실증). 잔여 = 사용자 확인 후 작가 발송 · 22화 이후 발주 시점 미정 |
