...
- 2026-09-22 **FINAL v42** = `07_final/34_storm_dragon_bride_FINAL_v42_CN&KO&EN.docx` + `.md`. 52화 암전 컷 자세(손바닥 심장 위 → 두 팔로 목 끌어안기 · 그는 뒷머리·허리). 3줄. 변경 목록 = `34_storm_dragon_bride_v42_changes.md`.

- 2026-09-22 **FINAL v43** = `07_final/34_storm_dragon_bride_FINAL_v43_CN&KO&EN.docx` + `.md`. 52화 암전 = 한창 뜨거운 도중(눌러 눕힘·목 끌어안아 끌어내림·숨 급해짐)에서 끊기. 옷 동작 0. 3줄. 변경 목록 = `34_storm_dragon_bride_v43_changes.md`.

- 2026-09-22 **FINAL v44** = `07_final/34_storm_dragon_bride_FINAL_v44_CN&KO&EN.docx` + `.md`. 52화 키스 블록 묘사 20% 압축(1971→1504자 · 12줄). 변경 목록 = `34_storm_dragon_bride_v44_changes.md`.

- 2026-09-22 **FINAL v45** = `07_final/34_storm_dragon_bride_FINAL_v45_CN&KO&EN.docx` + `.md`. 52화 암전 컷 — 끌어 눕히며 키스 계속 · 으르렁·이 스침·허리 고정(짐승미) · 오필리아 눈물+입꼬리(기쁨). 3줄. 변경 목록 = `34_storm_dragon_bride_v45_changes.md`.

- 2026-09-22 **FINAL v46** = `07_final/34_storm_dragon_bride_FINAL_v46_CN&KO&EN.docx` + `.md`. 52화 암전 컷 최종형 — 끌어 눕힘·으르렁·허리·눈물+입꼬리·"뜨거운 키스를 이어 간다"·【암전】(과한 명시 제거). 3줄. 변경 목록 = `34_storm_dragon_bride_v46_changes.md`.

- 2026-09-22 **FINAL v47** = `07_final/34_storm_dragon_bride_FINAL_v47_CN&KO&EN.docx` + `.md`. 52화 암전 컷 부연(으르렁·허리) 삭제. 3줄. **교훈: 지문에 부연 묘사 덧붙이지 말 것 — 동작·표정 사실만.** 변경 목록 = `34_storm_dragon_bride_v47_changes.md`.
...
- 2026-09-23 **FINAL v64** = `07_final/I Bought the Dragon Lord for One Night_FINAL_v64_CN&KO&EN.docx` + `.md`. 사용자 진단 "원작 약점 = 고수위 외 후킹 안 됨 → 관계·모욕·배신·굴욕·사이다 보강 + 분량 다이어트" → opus 3기 수술 제안 → 메인 판정 → 고쳐 쓰기 약 90세트 + 삭제 약 100세트. 지문 882→782 · 영어 대사 4,868→4,763단어 · 중문 지문 원작 이하 → 추정 약 64분. 대표: 1화 가릭이 비비안 곁으로 건너감·손수건 뒤 웃음 / 2화 사브리나 손수건 → 화로 · 치맛자락이 사브리나 손가락 위 / 5화 사브리나 기어 나감 / 14화 비비안 오필리아 발밑 / 19화 가릭이 손 짓밟음 → 20화 네 발로 도망 / 27화 잿더미에 얼굴 / 34화 비비안 굽으로 망토 · 국왕 "Crawling back to your father" / 38화 국왕 공개 무릎 / 47화 "I'm your father!". 14~15화 대장로 화자 통일. 변경 목록 = `34_storm_dragon_bride_v64_changes.md`.
