...
- **편당 길이:** 90초-3분
- **총 러닝타임:** 약 90-150분
- **수위:** 다크 로맨타지 고수위 (할리퀸 Presents·Berkley 다크·Ballantine Outlander 톤 / 침실 긴장·금지된 끌림·공개 소유 선언·키스·신체 접촉 강도 강·직접 성행위 묘사 X)
...
| **5. Forbidden Touch + Erotic Permission** | 다크 로맨타지 고수위 (할리퀸 Presents·Berkley·Ballantine Outlander 톤) — 절제된 수위 EP18+ 본격 |
...
- 베일이 이솔데를 신부로 선언하려는 순간 — 드래곤 무리 첫 포효
- 사절단 호위병 12명 전원 무릎 꺾음
- 이솔데가 베일의 손등 비늘을 자기 손으로 감싸기 시작

→ **다음 화에 무엇이 회수될지:** 베일의 신부 선언 완성 / 드래곤 무리 본격 등장 / 인간 왕국 알드릭 왕의 음모
...
| **EP8 (페이월)** | **Public Recognition of Bond 시작** (깃발 태움 + 드래곤 포효 + 신부 선언 직전) | 베일의 신부 선언 의지 / 드래곤 무리 첫 포효 | 신부 선언 완성 (Mate Sealed) | 신부 선언 끊김 + 사절단 무릎 + 이솔데가 베일 비늘 감쌈 | **Mate Sealed → Crowned Bride** |
